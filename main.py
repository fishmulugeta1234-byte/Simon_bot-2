...
# Grid columns run Sat → Fri (matches the "S S M T W T F" header used
# throughout the check-in grid), expressed as Python .weekday() values
# (Mon=0 ... Sun=6).
GRID_HEADER = "     S  S  M  T  W  T  F"
